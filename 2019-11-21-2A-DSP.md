...
```
è un linguaggio di programmazione, testuale (si scrive un testo che viene interpretato) funzionale (a un solo scopo),ovvero si usa per scrivere programmi audio
```
